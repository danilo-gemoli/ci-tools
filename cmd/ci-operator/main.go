...
func bindOptions(flag *flag.FlagSet) *options {
	...
	flag.BoolVar(&opt.enableSecretsStoreCSIDriver, "enable-secrets-store-csi-driver", false, "Access secrets by using the secrets store CSI interface")
